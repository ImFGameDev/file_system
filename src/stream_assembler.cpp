...
namespace main_player::core::stream
{
	//private:
	template<typename T>
	bool stream_assembler::load(const std::string& filePath, T& output)
	{
		try
		{
	...
	//public:
	template<typename T>
	bool stream_assembler::parce_to_object(const std::string& stream_data, T& output)
	{
		try
		{
	...
	template<typename T>
	std::string stream_assembler::to_json(const T& data)
	{
		try
		{
	...
	template<typename T>
	bool stream_assembler::read_file(const std::string& filePath, T& output)
	{
		try
		{
			std::ifstream file(filePath);
	...
	template<typename T>
	bool stream_assembler::find_read_file(const std::string filePath[], const std::size_t& length,
	...
	template<typename T>
	bool stream_assembler::find_read_file(const std::vector<std::string>& filePath, const std::string& name, T& output)
	{
	...
	template<typename T>
	void stream_assembler::write_file(const std::string& filePath, const T& data)
	{
		try
		{
